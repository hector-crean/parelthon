...
function MutationResult<TData, TError = Error, TVariables = unknown, TContext = unknown>({ children, mutationResult, renderInitial, renderLoading = () => null, renderError = () => null }: Props<TData, TError, TVariables, TContext>) {
